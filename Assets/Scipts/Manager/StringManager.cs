...
public static class StringManager
{
    ...
    public static readonly string emailTemplateID = "20C0D1B4D718FCD4";


    //===============Menuoffline======================
    public static readonly string hasPlayed = "HasPlayed";

    public static readonly string levelReached = "Level_Reached";

    //==============game play ========================
    public static readonly string boardGameCrt = "Board Manager";
    public static readonly string highScoreStr = "High_Score";

    //================form============================
    public static readonly string formCanvas = "Canvas_Font_Forms";
